...
export default function Cart(){
    return(
        <>
           <div className=" pl-5">
           <BreadcrumbDemo/>
           <h1 className="text-2xl md:text-4xl font-extrabold  mt-2">YOUR CART</h1>
           </div>
        <div className="flex flex-col md:flex-row justify-center items-start gap-3 mt-6">
              ...
              {/* right div */}
              <div className="w-full md:w-[400px] h-full md:h-[450px] border rounded-[30px]  flex flex-col justify-start items-center p-4">
                   ...
                   <div className="flex">
                   <input className="bg-[#F0F0F0] w-[200px] md:w-full py-2 px-5 rounded-[30px] text-gray-600 outline-none" placeholder="Add promo code" />
                   <Button className="ml-1 bg-black text-white rounded-[30px]">Apply</Button>
                   </div>
                    <Button className="w-full bg-black text-white rounded-[30px]">Go To Checkout</Button>
