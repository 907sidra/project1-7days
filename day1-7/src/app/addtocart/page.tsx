...
const Cartt = () => {
    ...
    const handleProceed = () => {
        Swal.fire({
            ...
            icon: "question",
            showCancelButton: true,
            confirmButtonColor: "#38555d",
            cancelButtonColor: "#d33",
            confirmButtonText: "Yes, proceed!"
        }).then((result) => {
            if (result.isConfirmed) {
                Swal.fire("Success!", "Item has been successfully proceed.", "success");
    ...
    return (
        <div className="max-w-4xl mx-auto p-4">
            ...
            <div className="space-y-4">
                {cartItems.map((item) => (
                    <div key={item._id} className="flex items-center justify-between p-4 bg-white shadow-md rounded-lg">
            ...
            <div className="mt-6 p-4 bg-gray-100 rounded-lg shadow-md">
                ...
                <button onClick={handleProceed} className="mt-4 w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-600">Proceed to Checkout</button>
            </div>
        </div>
    );
};
